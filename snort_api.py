...
#               "rule": "alert icmp any any -> any any (msg:'Pinging detected'; sid:101;)"
                ...
                with open("./rules/simple_icmp_net.rules", 'a+') as snort_rules:
        ...
        if del_json_elements(snort_json):
            ...
            if snort_db_entry == []:
                ...
                with open("./rules/simple_icmp_net.rules", 'r') as snort_rules:
                    snort_lines = snort_rules.readlines()

                with open("./rules/simple_icmp_net.rules", 'w') as snort_rules:
